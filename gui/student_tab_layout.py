...
def borrow_and_return_page_layout():
    ...
    student_main_screen_layout = [
        [sg.Push(background_color='white'), sg.Button(button_text='Borrow Item', key='-borrow_item-', font=font, size=20, pad=((50,50), (50,0))), sg.Push(background_color='white')],
        [sg.Push(background_color='white'), sg.Button(button_text='Return Item', key='-return_item-', font=font, size=20, pad=((50,50), (50,50))), sg.Push(background_color='white')]
    ]
    ...
    layout_student = [
        [sg.VPush()],
        [sg.Column(student_main_screen_layout, key='-student_main_screen-', visible=True, background_color='white'),
